...
export function useAdminData() {
    ...
    try {
      ...
      const [
        ...
        supabase
          ...
          .select("transaction_id,member_id,points,transaction_type,transaction_date,reason, loyalty_members(first_name, last_name, member_number)")
  ...
  const metrics = useMemo(() => {
    ...
    for (const tx of transactions) {
      ...
      const label = String(tx.reason || "General Reward").trim() || "General Reward";
